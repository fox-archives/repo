...
export * as c from "https://deno.land/std@0.144.0/fmt/colors.ts";
export * as fs from "https://deno.land/std@0.144.0/fs/mod.ts";
export * as path from "https://deno.land/std@0.144.0/path/mod.ts";
export * as toml from "https://deno.land/std@0.144.0/encoding/toml.ts";
export * as yaml from "https://deno.land/std@0.144.0/encoding/yaml.ts";
